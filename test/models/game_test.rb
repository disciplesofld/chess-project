...
class GameTest < ActiveSupport::TestCase
  ...
  test "second user can view game to join" do
    started_game = FactoryGirl.create(:game, player_white_id: nil)
    Game.where(player_white_id: nil).find_each do |game|
  ...
  def create_game_pieces(x_1, y_1, x_2, y_2, new_x, new_y)
    ...
    game.game_pieces << Rook.new(x: x_1, y: y_1, type: "Rook", game_id: 1, user_id: 1)
    game.game_pieces << Rook.new(x: x_2, y: y_2, type: "Rook", game_id: 1, user_id: 1)
  ...
  test "gamepiece is obstructed by another player piece" do
    ...
    game = FactoryGirl.create(:game)
    game.game_pieces << Rook.new(x: 0, y: 0, type: "Rook", game_id: 1, user_id: 1)
    game.game_pieces << Rook.new(x: 0, y: 1, type: "Rook", game_id: 1, user_id: 2)
    gamepiece = Rook.first
