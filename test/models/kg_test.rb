...
module KG
  ...
  class GameTest < ActiveSupport::TestCase
    ...
    test "piece alive and move piece" do
      ...
      white_king = FactoryGirl.create(:king, x: 0, y: 4, type: 'King', user: white, game: h)
      # p white_king
      assert_equal(true,  white_king.alive)
    ...
    test "is valid move and Rook check to king" do
      ...
      white_king = FactoryGirl.create(:king, x: 3, y: 4, type: 'King', user: white, game: h)
      black_rook = FactoryGirl.create(:rook, x: 0, y: 4, type: 'Rook', user: black, game: h)
      # p black_rook
    ...
    test "Opponent Queen check to king" do
      ...
      white_king = FactoryGirl.create(:king, x: 3, y: 4, type: 'King', user: white, game: h)
      black_queen = FactoryGirl.create(:queen, x: 4, y: 5, type: 'Queen', user: black, game: h)
      # p black_queen
    ...
    test "Opponent Bishop check to king" do
      ...
      black_bishop = FactoryGirl.create(:bishop, x: 7, y: 1, type: 'Bishop', user: black, game: h)
      # p black_bishop
    ...
    test "Opponent Pawn check to king" do
      ...
      black_pawn = FactoryGirl.create(:pawn, x: 3, y: 5, type: 'Pawn', user: black, game: h)
      # p black_pawn
    ...
    test "Opponent King check to king" do
      ...
      black_king = FactoryGirl.create(:king, x: 4, y: 5, type: 'King', user: black, game: h)
      # p black_king
    ...
    test "Opponent Knight check to king" do
      ...
      white_king = FactoryGirl.create(:king, x: 3, y: 4, type: 'King', user: white, game: h)
      black_kinght = FactoryGirl.create(:knight, x: 5, y: 2, type: 'Knight', user: black, game: h)
      # p black_kinght
    ...
    test "Opponent Knight not check to king" do
      ...
      white_king = FactoryGirl.create(:king, x: 3, y: 4, type: 'King', user: white, game: h)
      black_kinght = FactoryGirl.create(:knight, x: 5, y: 5, type: 'Knight', user: black, game: h)
      # p black_kinght
